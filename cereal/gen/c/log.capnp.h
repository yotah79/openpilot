...
enum cereal_PathPlan_LaneChangeBSM {
	cereal_PathPlan_LaneChangeBSM_off = 0,
	cereal_PathPlan_LaneChangeBSM_left = 1,
	cereal_PathPlan_LaneChangeBSM_right = 2
};
...
static const size_t cereal_ThermalData_pointer_count = 2;

static const size_t cereal_ThermalData_struct_bytes_count = 72;
...
struct cereal_PathPlan {
	...
	enum cereal_PathPlan_LaneChangeBSM laneChangeBSM;
};
