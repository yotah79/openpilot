...
enum cereal_CarEvent_EventName {
	...
	cereal_CarEvent_EventName_turningIndicatorOn = 69,
	cereal_CarEvent_EventName_lkasButtonOff = 70,
	cereal_CarEvent_EventName_rightLCAbsm = 71,
	cereal_CarEvent_EventName_leftLCAbsm = 72,
	cereal_CarEvent_EventName_preventLCA = 73,
	cereal_CarEvent_EventName_steerTorqueOver = 74
};
...
enum cereal_CarControl_HUDControl_AudibleAlert {
	...
	cereal_CarControl_HUDControl_AudibleAlert_chimeReady = 8,
	cereal_CarControl_HUDControl_AudibleAlert_chimeDoorOpen = 9,
	cereal_CarControl_HUDControl_AudibleAlert_chimeGearDrive = 10,
	cereal_CarControl_HUDControl_AudibleAlert_chimeLaneChange = 11,
	cereal_CarControl_HUDControl_AudibleAlert_chimeLaneDeparture = 12,
	cereal_CarControl_HUDControl_AudibleAlert_chimeRoadWarning = 13,
	cereal_CarControl_HUDControl_AudibleAlert_chimeSeatBelt = 14,
	cereal_CarControl_HUDControl_AudibleAlert_chimeViewUncertain = 15
};
...
struct cereal_CarState {
	...
	float distanceToggle;
	unsigned laneDepartureToggle : 1;
	unsigned doorOpen : 1;
	unsigned seatbeltUnlatched : 1;
	unsigned canValid : 1;
	unsigned clutchPressed : 1;
	float readdistancelines;
	unsigned lkMode : 1;
	unsigned lcaLeft : 1;
	unsigned lcaRight : 1;
...
static const size_t cereal_CarState_word_count = 7;

static const size_t cereal_CarState_pointer_count = 6;

static const size_t cereal_CarState_struct_bytes_count = 104;
